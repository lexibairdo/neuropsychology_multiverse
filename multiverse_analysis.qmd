...
```{r}
add_f2 <- function(data, r2_column = "fit_r.squared") {
...
```{r}
PSI_results_df <- add_f2(PSI_results_df, r2_column = "fit_r.squared")
...
mv_complete$SWLS_DRS_Composite <- (mv_complete$SWLSTotalScore + mv_complete$DRS_Scaled) / 2
...
qol_specs_results_df <- add_f2(qol_specs_results_df, r2_column = "fit_r.squared")
#save as excel
write_xlsx(qol_specs_results_df, "qol_specs_results_df.xlsx")
```
...
mood_outcome_results_df <- add_f2(mood_outcome_results_df, r2_column = "fit_r.squared")
```
